...
<head>
    ...
    <!-- Page Title -->
    <title>Pillsmart - Automated System for Medicinal and Healthcare Industry</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/PillSmart-logo.png" type="image/x-icon">
    ...
    <header class="header-area">
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.php">
                        <img src="assets/PillSmart-logo.png" style="height: 100px; width:100px;" alt="">
                    </a>
                </div>
