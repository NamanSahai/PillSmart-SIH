<html style="background-color: #02766f;">
    ...
    <center>
            ...
            <div class="positioning" style="background-color: white;opacity:30%;">
                <img src="/IMAGES/PillSmart-removebg-preview.png" style="left: 20%;height: 5%;">
            </div>
            <h1 class="hello">Hello,<br>Patient</h1></a>
            <div style="background-color:white;width:40%;height:80%;left: 10%;top:10%;position: absolute;">
                <form style="padding-left: 50px;top: 10%;position: absolute;">
                    <table style="border-spacing: 10px 15px;">
                        <thead>
                            <th colspan="2" style="font-family: 'Montserrat', sans-serif;font-size:50px;padding-right: 80px;">Patient Sign-In</th>
                        </thead>
                        <tr>
                            <td>Patient ID</td><td><input type="text" name="NAME1"></td>
