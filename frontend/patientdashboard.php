    ...
    <center>
            ...
            <div class="positioning_1">
                <form class="dashboard" style="top: 10%;position: absolute;">
                    ...
                    <thead><th style="padding-right: 50%;"><a href="main_login.php" style="color: white; text-decoration: none;font-size:70px">PillSmart</a></th></thead>
                        <tr><td><a href="patientsingnin.php" class="buttons">Medical Records</a></td></tr>
                    <tr><td><a href="diagonisticreports.php" class="buttons">Diagonistic Report</a></td></tr>
                    <tr><td><a href="employeesingnin.php" class="buttons" style="font-size: 26px;">Prescription</a></td></tr>
                    </table>
                </form>
            </div>
